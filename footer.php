				...
				<div class="footer_top<?php if(!$footer_in_grid) {echo " footer_top_full";} ?>">
					...
					<div class="container">
						<div class="container_inner">
							<div><img style="margin-bottom: 10px; display: block; margin: auto;" src="http://harvesthill.staging.wpengine.com/wp-content/uploads/2017/10/hh-footer-logo.png"></div>
