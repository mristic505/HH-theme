...
<form class="job_filters">
	...
	<div class="search_jobs">
		...
		<div class="search_fields_holder clearfix">

			<div class="clearfix">
				<div class="search_keywords">
					<label for="search_keywords"><?php _e( 'Keywords', 'wp-job-manager' ); ?></label>
					<input type="text" name="search_keywords" id="search_keywords" placeholder="Search Keyword, Category or Job Title" value="<?php echo esc_attr( $keywords ); ?>" />
				</div>

				<div class="search_location">
					<label for="search_location"><?php _e( 'Location', 'wp-job-manager' ); ?></label>
					<input type="text" name="search_location" id="search_location" placeholder="Search Location, City or Postal Code" value="<?php echo esc_attr( $location ); ?>" />
				</div>
			</div>

			<div class="search_btn">SEARCH JOBS</div>
